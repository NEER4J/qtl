...
import { addSalesPayment } from "@/lib/actions/sales";
import { AddSalesPaymentInput } from "@/lib/schemas/sales";
...
export function AddPaymentDialog({
  ...
  const onSubmit = form.handleSubmit((values) => {
    const parsed = AddSalesPaymentInput.safeParse({
    ...
    startTransition(async () => {
      const res = await addSalesPayment(parsed.data);
      if (!res.ok) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Outstanding balance after this payment is recalculated automatically.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
